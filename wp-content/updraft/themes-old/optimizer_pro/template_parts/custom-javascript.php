	...
	//FORM VALIDATION
		jQuery('#layer_contact_form').isHappy({
			fields: {
			  ...
			  '#layer_cntct_gdpr_policy': {
				  required: true,
				  message: '<?php _e('Please agree to the Terms', 'optimizer'); ?>',
				  error_target: '#layer_cntct_gdpr_policy',
				  when: 'change',
				  test: function(){ 
					return jQuery('#layer_cntct_gdpr_policy').is(':checked');
				  },
				},
			  <?php } ?>
			}

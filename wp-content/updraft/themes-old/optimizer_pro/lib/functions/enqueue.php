...
function widgetizer_enqueue($hook) {
		...
		if ( 'post.php' == $hook ) {
			  ...
			  if($widgetized == '1' && $sidebarid !=='null' ){
				$cpanel = '<div id="customize_page_panel_new" class="page_widgetized_new active_customize"><a id="customize_page_bttn_new">Customize</a><div class="custimize_pp_inner_new">';
				...
				$cpanel = '<div id="customize_page_panel_new"><a id="customize_page_bttn_new">Customize</a><div class="custimize_pp_inner_new"><p>'. __('Customize This Page with Widgets like Optimizer Frontpage.','optimizer').'</p>';

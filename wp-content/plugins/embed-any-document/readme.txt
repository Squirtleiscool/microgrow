...
By using <strong><a href="http://embedanydocument.com/plus-cc"> Embed Any Document PLUS </a></strong> you can make use of the privacy options the cloud services (Google Drive, Dropbox and Box.com) offering you. You can remove download options, embed larger files, put passwords and even restrict the views. 

<h3>Limitations of the plugin</h3>
...
* Your document has to be available online for the embed views to work. The viewers do not support locally hosted files or files hosted in a protective environment like an intranet
...
* Any feature that comes by default with the viewers (including download and pop-out buttons) cannot be removed or altered
